...
CHECK_OVERHEAT:
	TEMPERATURE_CHECKER(#32H, #02H, x_gteq_y, bcd+1)
	jnb mf, STAGE4_REFLOW_FREQUENCY
	clr mf
	ljmp OVERHEAT_FREQUENCY		;should we turn off the program? or just lower power?
...
STAGE5_COOLING:
	jb STAGE5_DONE_FLAG, STAGE5_COOLING_FREQUENCY
	TEMPERATURE_CHECKER (#30H, #0, x_lteq_y, #0) ;if temp <= 30, beep six times
	jnb mf, STAGE5_COOLING_FREQUENCY
	lcall beep_once
	lcall beep_once
	lcall beep_once
	lcall beep_once
